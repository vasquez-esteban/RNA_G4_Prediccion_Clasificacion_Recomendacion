...
- [6. Herramienta Web Integrada](#herramienta-web)
  - [6.1 Arquitectura de la Aplicación](#61-arquitectura-de-la-aplicación)
  - [6.2 Módulo de Clasificación de Conducción Distractiva](#62-módulo-de-clasificación)
  - [6.3 Módulo de Predicción de Demanda de Transporte](#63-módulo-de-predicción)
  - [6.4 Módulo de Recomendación de Destinos](#64-módulo-de-recomendación)
  - [6.5 Despliegue y Accesibilidad](#65-despliegue-y-accesibilidad)
...
```{r fig1-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 1. Demanda total diaria'}
...
```{r fig2-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 2. Descomposición estacional de la Demanda Mensual'}
...
```{r fig3-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 3. Función ACF y PACF'}
...
```{r fig4-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 4. Comparación con diferenciación'}
...
```{r fig5-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 5. Demanda Mensual por Destino'}
...
```{r fig6-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 6. Demanda promedio por día de la semana'}
...
```{r fig7-eda-demanda, out.width="60%", fig.align='center', fig.cap='Figura 7. Distribución de Pasajeros por Mes'}
...
```{r fig21, out.width="60%", fig.align='center', fig.cap='Figura 21. Correlación de variables con ExperienceRating'}
...
```{r fig22, out.width="60%", fig.align='center', fig.cap='Figura 22. Preferencias más comunes de los usuarios'}
...
```{r fig23, out.width="60%", fig.align='center', fig.cap='Figura 23. Cantidad de visitas registradas por mes'}
...
```{r fig24, out.width="60%", fig.align='center', fig.cap='Figura 24. Evolución de la pérdida MSE en train y validación'}
...
```{r fig25, out.width="60%", fig.align='center', fig.cap='Figura 25. Comparación entre rating real y predicho'}
...
```{r fig26-clasificacion-interfaz, out.width="70%", fig.align='center', fig.cap='Figura 26. Interfaz de clasificación de conducción distractiva con instrucciones de uso.'}
knitr::include_graphics("imgs/app/clasificacion_1.png")
```
...
```{r fig27-clasificacion-correcto, out.width="70%", fig.align='center', fig.cap='Figura 27. Ejemplo de clasificación correcta: conductor escribiendo en el teléfono.'}
knitr::include_graphics("imgs/app/clasificacion_2.png")
```
...
```{r fig28-clasificacion-error, out.width="70%", fig.align='center', fig.cap='Figura 28. Ejemplo de clasificación errónea.'}
knitr::include_graphics("imgs/app/clasificacion_3.png")
```
...
```{r fig29-demanda-interfaz, out.width="70%", fig.align='center', fig.cap='Figura 29. Interfaz del módulo de predicción de demanda con ejemplo de la ruta Taj Mahal.'}
knitr::include_graphics("imgs/app/demanda.png")
```
...
```{r fig30-recomendacion-interfaz, out.width="70%", fig.align='center', fig.cap='Figura 30. Interfaz del sistema de recomendación con ejemplo de usuario personalizado.'}
knitr::include_graphics("imgs/app/recomendacion.png")
```
...
<ul>
  <li><a href="https://evasp-rna-g4-trabajo3.hf.space/" target="_blank">Hugging Face Space – Demo interactiva</a></li>
</ul>

<h3>Recursos Complementarios</h3>
<ul>
  <li><b>Video: </b><a href="https://www.youtube.com/watch?v=c_Ndzs11zYI" target="_blank">Enlace</a></li>
</ul>
